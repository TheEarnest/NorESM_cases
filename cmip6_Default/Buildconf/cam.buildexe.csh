...
/cluster/home/earnest/tools/NorCPM/models/noresm1-cmip6/models/atm/cam/src/chemistry/pp_none
...
set camdefs = "   -DCO2A -DMAXPATCH_PFT=numpft+1 -DLSMLAT=1 -DLSMLON=1 -DPLON=144 -DPLAT=96 -DPLEV=26 -DPCNST=28 -DPCOLS=16 -DPTRM=1 -DPTRN=1 -DPTRK=1 -DSTAGGERED  -DSPMD -DAERLIFE -DDIRIND -DCMIP6 -DCONDFIX -DRCP85"
