...
set camdefs = "   -DCO2A -DMAXPATCH_PFT=numpft+1 -DLSMLAT=1 -DLSMLON=1 -DPLON=288 -DPLAT=192 -DPLEV=30 -DPCNST=25 -DPCOLS=16 -DPTRM=1 -DPTRN=1 -DPTRK=1 -DSTAGGERED  -DOFFLINE_DYN -DSPMD -DDUST -DPROGSSLT -DMODAL_AERO -DMODAL_AERO_3MODE "
