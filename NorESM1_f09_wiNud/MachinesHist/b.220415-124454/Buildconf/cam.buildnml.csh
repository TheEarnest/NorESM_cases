...
&cam_inparm
 ...
 cam_branch_file		= '/cluster/work/users/earnest/noresm/NorESM1_f09_wiNud/run/NorESM1_f09.cam2.r.1980-01-01-00000.nc'
 dtime    = 1800
 fincl1   =  'SST', 'Z700', 'Z500', 'Z200', 'Z300', 'Z100', 'Z050', 'U200', 'U850', 'V200', 'V850', 'T200', 'T500', 'T700', 'T1000', 'OMEGA500', 'OMEGA850', 'ICEFRAC'
 fincl2   = 'U:I', 'V:I', 'T:I', 'Q:I', 'PS:I', 'T200:I', 'U200:I', 'V200:I', 'Z200:I'
 mfilt     = 12,1
 ncdata   = '$DIN_LOC_ROOT/atm/cam/inic/fv/cami_1987-01-01_0.9x1.25_L26_c060703.nc'
 nhtfrq    = 0,-6



 met_data_file    = '1980/ERAint_nuCAM_198001_MLS310315.nc'
 met_data_path    = '/cluster/projects/nn9385k/people/earnest/AMIP/CAM_nudging/ERAL26_f09'

 met_filenames_list   = '/cluster/projects/nn9385k/people/earnest/AMIP/CAM_nudging/ERAL26_f09/ERAint_F19tn21L26_MLS310315.txt'

 met_cell_wall_winds = .false.
 met_fix_mass   = .false.
 met_max_rlx = 0.083333
 met_rlx_bot    = 113.
 met_rlx_top    = 131.
/
&chem_surfvals_nl
