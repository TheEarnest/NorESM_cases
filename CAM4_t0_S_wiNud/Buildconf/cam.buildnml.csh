...
&cam_inparm
 ...
 fincl2   = 'U:I', 'V:I', 'T:I', 'Q:I', 'PS:I', 'T500:I', 'U500:I', 'V500:I', 'Z500:I', 'OMEGA500:I'
 fincl3   = 'T500', 'U500', 'V500', 'Z500', 'OMEGA500'
 mfilt     = 12,1,1
 ncdata   = '$DIN_LOC_ROOT/atm/cam/inic/fv/cami_0000-01-01_1.9x2.5_L26_c070408.nc'
 nhtfrq    = 0,1,-6

 met_data_file    = '1979/ERAint_nuCAM_197901_MLS310315.nc'
 met_data_path    = '/cluster/projects/nn9039k/CAM_Nudging/met_data/ERAL26'

 met_filenames_list   = '/cluster/projects/nn9039k/CAM_Nudging/met_data/ERAint_F19tn21L26_MLS310315.txt'

 met_fix_mass   = .true.
 met_max_rlx = 0.08333333333333333
 met_rlx_bot    = 30.
 met_rlx_top    = 40.
